#ifndef CUSTOM_TOONLIT_INPUT_INCLUDED
#define CUSTOM_TOONLIT_INPUT_INCLUDED
...
UNITY_INSTANCING_BUFFER_START(UnityPerMaterial)
    ...
    UNITY_DEFINE_INSTANCED_PROP(float, _ShadowDarknessScale)
...
float GetShadowThreshold(InputConfig c)
{
    return INPUT_PROP(_ShadowThreshold);
}

float GetShadowDarknessScale(InputConfig c)
{
    return INPUT_PROP(_ShadowDarknessScale);
}
